...
<%-- 														<TD>${customer.linkmen.lkm_name }</TD> --%>
														<TD>${customer.cust_phone }</TD>
														<TD>${customer.cust_mobile }</TD>
														<TD><a
															href="${pageContext.request.contextPath }/CustomerAction_modify?cust_id=${customer.cust_id}">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/CustomerAction_delete?cust_id=${customer.cust_id}">删除</a>
														</TD>
													</TR>
